...
function signal = generateSignal(signalType, signalSize, prbsClockPeriod)
    ...
    switch signalType
        ...
        case 3
            ...
            signal = [zeros(floor(signalSize / 3), 1); ...
                    idinput([floor(signalSize / 3), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3]); ...
                    zeros(floor(signalSize / 3), 1)];

        case 4

            signal = [idinput([floor(signalSize / 3), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3]); ...
                                                                        zeros(floor(signalSize / 3), 1); ...
                                                                        idinput([floor(signalSize / 3), 1], 'prbs', [0 1/prbsClockPeriod], [-3 3])];

        case 5

            signal = [zeros(floor(signalSize / 6), 1); ...
                    idinput([floor(signalSize / 6), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3]); ...
                    zeros(floor(signalSize / 6), 1); ...
                    idinput([floor(signalSize / 6), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3]); ...
                    zeros(floor(signalSize / 6), 1); ...
                    idinput([floor(signalSize / 6), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3])];
        ...
        case 6
            ...
            signal = [idinput([floor(signalSize / 6), 1], 'rbs', [0 1/prbsClockPeriod], [-3 3]); ...
                                                                        zeros(floor(signalSize / 6), 1); ...
                                                                        idinput([floor(signalSize / 6), 1], 'prbs', [0 1/prbsClockPeriod], [-3 3]); ...
                                                                        zeros(floor(signalSize / 6), 1); ...
                                                                        idinput([floor(signalSize / 6), 1], 'prbs', [0 1/prbsClockPeriod], [-3 3]); ...
                                                                        zeros(floor(signalSize / 6), 1)];
