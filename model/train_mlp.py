...
if __name__ == '__main__':
    ...
    train_dataset, test_dataset = dataset_util.generate_datasets(
        data_path=DATA_PATH, x_data = ["accelerationX_"], y_data = "signal_", sequence_length=SEQUENCE_LENGTH, network_type=NETWORK_TYPE, concat_all=CONCAT_ALL, train_test_split=0.8)
    ...
    optimizer = torch.optim.Adam(
        model_.parameters(), lr=5e-4, weight_decay=1e-4)
